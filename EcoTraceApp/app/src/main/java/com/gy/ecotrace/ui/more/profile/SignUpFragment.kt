...
//        if (DatabaseMethods().isUser(username, email)) return "0"
...
//        val dataInfo = DatabaseMethods.UserInfo(username, fullname, gender, country)
//        val dataPrivate = DatabaseMethods.UserPrivate(email.replace(".", "!"), DatabaseMethods().hash256(password))
//        val dataRules = DatabaseMethods.UserRules()
...
//        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        registerBtn.setOnClickListener {
            GlobalScope.launch {
                val newId = createNewUser(
                    usernameEntry.text.toString(),
                    fullnameEntry.text.toString(),
                    if (genderSwitcher.isActivated) 1 else 0,
                   "bye",
                ...
                if (newId == "0") {
                    ...
                    Globals().setString("CurrentlyLogged", newId)
                    Globals().setString("CurrentlyWatching", newId)

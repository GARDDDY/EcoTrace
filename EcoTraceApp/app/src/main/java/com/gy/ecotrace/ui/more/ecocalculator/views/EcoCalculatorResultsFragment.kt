 ...
 * Use the [EcoCalculatorResultsFragment.newInstance] factory method to
...
class EcoCalculatorResultsFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EcoCalculatorResultsFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EcoCalculatorResultsFragment().apply {
